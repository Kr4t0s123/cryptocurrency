...
describe('Transaction' , ()=>{
    ...
    beforeEach(()=>{
        ...
        describe('outputMap' ,()=>{
            ...
            it('outputs the remaining balance for the `sendWallet`' ,()=>{
        ...
        describe('validTransaction()' ,()=>{
            ...
            describe('when transaction is invalid' ,()=>{
                describe('and a transaction outputMap is invalid' ,()=>{
                    it('return false ans logs error' ,()=>{
        ...
        describe('rewardTransaction()' , ()=>{
            ...
            it('creates a transaction with thr reward input' ,()=>{
                expect(rewardTransaction.input).toEqual(REWARD_INPUT)
            })

            it('creates ones transaction for the miner with `MINER_REWARD`' ,()=>{
